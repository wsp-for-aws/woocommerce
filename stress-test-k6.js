...
// domain name where our WooCommerce is set up
var domainName;
var pscheme = 'https';
...
export let options = {
    stages: [
        ...
        // Hold at 50 VUs for the next period
        { target: 50, duration: "10m" },
        // Linearly ramp down from 50 to 0 VUs over the last minute
    ...
    thresholds: {
        ...
        "check_failure_rate": [
            ...
            "rate<0.01",
            // Abort the test early if it climbs over 10%
...
export default function () {
    ...
    let checkRes = check(response, {
        ...
        "content is present": (r) => r.body.indexOf("WSP AWS") !== -1,
    });
